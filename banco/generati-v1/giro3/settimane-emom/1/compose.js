/* Script di composizione "ordine standard" per l'API v1 (lib/API-v1.md): dà la stessa sequenza del rendering di riserva v1
   (lib/engine/fallback.js), scritta con i soli dati e i costruttori di api.steps. È l'esempio che il generatore v1 riceve:
   uno script generato parte da qui e cambia l'ordine solo quando la scheda lo chiede, dichiarandolo in «logica».
   Nessun numero proprio: solo indici e campi dei dati; sincrono, deterministico. */

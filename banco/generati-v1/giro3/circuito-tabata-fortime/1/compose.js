/* Script di composizione "ordine standard" per l'API v1 (lib/API-v1.md): dà la stessa sequenza del rendering di riserva v1
   (lib/engine/fallback.js), scritta con i soli dati e i costruttori di api.steps. Nessuna modifica rispetto all'esempio
   standard: la scheda non richiede un ordine diverso. */

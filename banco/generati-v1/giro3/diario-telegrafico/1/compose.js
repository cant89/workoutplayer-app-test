/* Script di composizione "ordine standard" per l'API v1 (lib/API-v1.md): dà la stessa sequenza del rendering di riserva v1
   (lib/engine/fallback.js), scritta con i soli dati e i costruttori di api.steps. Nessuna logica aggiunta rispetto
   all'ordine standard: la scheda non richiede un ordine diverso. */
